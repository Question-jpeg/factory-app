...
import { BACKGROUND_COLOR, UI_COLOR, CELL_COLOR } from "./app/config/colors";
import {
  CELL_BORDER_WIDTH,
  CELL_SIZE,
  COUNT_SIZE,
  FIELD_SIZE,
  SIDEBAR_MARGIN_VERTICAL,
} from "./app/config/sizes";
import { MutableRefObject, useEffect, useRef, useState } from "react";
import { Asset, useAssets } from "expo-asset";
import Spawner from "./app/components/Spawner";
import { clampWorklet, getCoords, getNeighboursList } from "./app/utils";
import { ASSETS } from "./app/textures";
import Cell from "./app/components/Cell";
import { AppContext } from "./app/context";
import { BuildingAPI, Field, SpawnerAPI, Texture } from "./app/models";
import { SELECTIONS } from "./app/enums";
import Underlay from "./app/components/Underlay";
import UI from "./app/components/UI";
import { INITIAL_SELECTION } from "./app/config/values";
...
export default function App() {
  ...
  const placeBuilding = (coords: string, ref: BuildingAPI) => {
    if (ref) {
      if (field.current[coords]?.id !== ref.id) {
